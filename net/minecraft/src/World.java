    ...
    implements IBlockAccess
{
    ...
    {
        if(worldInfo.func_27115_l())
        {
            field_27078_C = 1.0F;
            if(worldInfo.func_27122_j())
            {
                field_27076_E = 1.0F;
            }
        }
    ...
    protected void func_27066_i()
    {
        ...
        int i = worldInfo.func_27117_k();
        if(i <= 0)
        {
            if(worldInfo.func_27122_j())
            {
                worldInfo.func_27121_b(rand.nextInt(12000) + 3600);
            } else
            {
                worldInfo.func_27121_b(rand.nextInt(0x29040) + 12000);
            }
        } else
        {
            i--;
            worldInfo.func_27121_b(i);
            if(i <= 0)
            {
                worldInfo.func_27119_a(!worldInfo.func_27122_j());
            }
        }
        int j = worldInfo.func_27120_m();
        if(j <= 0)
        {
            if(worldInfo.func_27115_l())
            {
                worldInfo.func_27118_c(rand.nextInt(12000) + 12000);
            } else
            {
                worldInfo.func_27118_c(rand.nextInt(0x29040) + 12000);
            }
        } else
        {
            j--;
            worldInfo.func_27118_c(j);
            if(j <= 0)
            {
                worldInfo.func_27116_b(!worldInfo.func_27115_l());
            }
        }
    ...
    {
        worldInfo.func_27118_c(0);
        worldInfo.func_27116_b(false);
        worldInfo.func_27121_b(0);
        worldInfo.func_27119_a(false);
    }
    ...
    protected void doRandomUpdateTicks()
    {
        ...
        for(Iterator iterator = activeChunkSet.iterator(); iterator.hasNext();)
        {
            ...
            if(rand.nextInt(16) == 0 && func_27068_v())
            {
                ...
                if(getWorldChunkManager().func_4067_a(j3 + k, j4 + i1).func_27049_c() && j5 >= 0 && j5 < 128 && chunk.getSavedLightValue(EnumSkyBlock.Block, j3, j5, j4) < 10)
                {
    ...
    public boolean func_27072_q(int i, int j, int k)
    {
        ...
        BiomeGenBase biomegenbase = getWorldChunkManager().func_4067_a(i, k);
